...
import {buySeatLevelOne} from "../../contractInteractions/Ticket"
   ...
   const options = [{ value: "Home" }, { value: "Away" }];
    ...
    const ticketMinted = async (
      ...
      try {
        ...
        const countTwo = await TicketContract.awaySeatLevelCount(1);
  ...
  return (
    <section className="h-[480px] max-w-[290px] bg-[#F5F5F5] px-3 md:px-6 pb-6 pt-8 my-16 mx-10 rounded-xl">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <button
          onClick={() =>
            buySeatLevelOne(homeorAway === "Home" ? true : false, signer)
          }
