...
const TicketCard = ({
  ...
  const ticketMinted = async (): Promise<void> => {
    ...
    try {
      const count = await TicketContract.homeSeatLevelCount(7);
      const countTwo = await TicketContract.awaySeatLevelCount(7);
  ...
  return (
    <section className="h-[480px] max-w-[290px] bg-[#F5F5F5] px-3 md:px-6 pb-6 pt-8 my-16 mx-10 rounded-xl">
      ...
      <div className="flex flex-col justify-center items-center">
        <p className="text-black mb-3">Seventh Row Seat</p>
        ...
        <button
          onClick={() =>
            buySeatLevelSeven(homeorAway === "Home" ? true : false, signer)
          }
