...
contract Resell is Ownable, ReentrancyGuard {
    ...
    function receiveTicketLevelOne(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelTwo(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelThree(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelFour(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelFive(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelSix(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelSeven(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelEight(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelNine(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
    ...
    function receiveTicketLevelTen(
        bool _homeOrAway,
        uint _tokenId,
        address _from
    )
